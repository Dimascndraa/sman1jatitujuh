				...
				<div class="card-header">
					<div class="clearfix">
						...
						<div class="float-right">
							<a href="?page=tambah_ekskul">Tambah</a>
						</div>
					</div>
				</div>
				<div class="card-body">
						...
						<tbody>
							<?php while ($row = mysqli_fetch_assoc($query)) : ?>
								<tr>
									...
									<td>
										<a href="ekskul/ubah.php?id=<?= $row['id'] ?>" class="btn btn-success btn-sm">Ubah</a>
										<a href="ekskul/hapus.php?id=<?= $row['id'] ?>" class="btn btn-danger btn-sm" onclick="return confirm('apakah anda yakin?')">Hapus</a>
									</td>
								</tr>
							<?php endwhile; ?>
						</tbody>
