				...
				<div class="card-header">
					<div class="clearfix">
						...
						<div class="float-right">
							<a href="?page=tambah_siswa">Tambah</a>
						</div>
					</div>
				</div>
				<div class="card-body">
						...
						<tbody>
							<?php while ($row = mysqli_fetch_assoc($query)) : ?>
								<tr>
									...
									<td><a href="siswa/detail.php?id=<?= $row['id'] ?>"><?= $row['nama'] ?></a></td>
									<td><?= $row['no_hp'] ?></td>
									<td><?= $row['jurusan'] ?></td>
									<td><?= $row['alamat'] ?></td>
									<td>
										<a href="siswa/ubah.php?id=<?= $row['id'] ?>" class="btn btn-success btn-sm">Ubah</a>
										<a href="siswa/hapus.php?id=<?= $row['id'] ?>" class="btn btn-danger btn-sm" onclick="return confirm('apakah anda yakin?')">Hapus</a>
									</td>
								</tr>
							<?php endwhile; ?>
						</tbody>
