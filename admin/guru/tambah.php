		...
		<div class="row">
			<div class="col">
				<div class="card shadow">
					...
					<div class="card-body">
						<form method="POST" action="guru/proses_tambah.php" enctype="multipart/form-data">
							...
							<div class="form-group">
								...
								<textarea name="pesan" id="ckeditor" class="ckeditor form-control"></textarea>
							</div>
							<div class="form-group">
								<button type="submit" class="btn btn-sm btn-primary" name="tambah">Tambah</button>
								<button type="reset" class="btn btn-sm btn-danger" onclick="return confirm('apakah anda yakin?')">Batal</button>
								<a href="?page=guru" class="btn btn-sm btn-secondary">Kembali</a>
							</div>
						</form>
					</div>
				</div>
