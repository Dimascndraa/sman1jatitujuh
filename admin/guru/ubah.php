...
<head>
	...
	<title>Ubah Guru - <?= $identitas['nama']; ?></title>
					...
					<div class="card-header">
						<div class="clearfix">
							...
							<div class="float-right">
								<a href="../index.php?page=guru">Kembali</a>
							</div>
						</div>
					</div>
					<div class="card-body">
						<form method="POST" action="proses_ubah.php?id=<?= $guru['id'] ?>" enctype="multipart/form-data">
							...
							<div class="form-group">
								...
								<textarea name="pesan" id="ckeditor" class="ckeditor form-control"><?= $visi_misi['visi_misi'] ?></textarea>
							</div>
							<div class="form-group">
								<button type="submit" class="btn btn-sm btn-primary" name="ubah">Ubah</button>
								<a href="../index.php?page=guru" class="btn btn-sm btn-secondary">Kembali</a>
							</div>
						</form>
					</div>
				</div>
